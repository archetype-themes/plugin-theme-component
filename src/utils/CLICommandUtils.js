import {
  ...
  BUILD_COMMAND_NAME,
  GENERATE_COMMAND_AVAILABLE_CALLER_TYPES,
  GENERATE_COMMAND_AVAILABLE_TARGET_TYPES,
  GENERATE_COMMAND_DEFAULT_TARGET_TYPE,
...
export function getAvailableCallerTypes (command) {
  switch (command) {
    ...
    case GENERATE_COMMAND_NAME:
      return GENERATE_COMMAND_AVAILABLE_CALLER_TYPES
...
export function getAvailableTargetTypes (command) {
  switch (command) {
    ...
    case GENERATE_COMMAND_NAME:
      return GENERATE_COMMAND_AVAILABLE_TARGET_TYPES
    case DEV_COMMAND_NAME:
...
export function getDefaultTargetType (command, targetName) {
  switch (command) {
    ...
    case GENERATE_COMMAND_NAME:
      return GENERATE_COMMAND_DEFAULT_TARGET_TYPE
    case DEV_COMMAND_NAME:
      return targetName ? Components.COMPONENT_TYPE_NAME : Components.COLLECTION_TYPE_NAME
    case INSTALL_COMMAND_NAME:
